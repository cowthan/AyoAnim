...
import org.ayo.robot.anim.ease.view.CursorView;
import org.ayo.robot.anim.ease.view.InterpolatorView;
...
public class InterpolatorAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Interpolator interpolator = mInterpolators[position].getEasingFunction();
