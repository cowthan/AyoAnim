...
import org.ayo.animate.ease.IFunction;
...
public class CustomActivity extends AppCompatActivity {
    ...
    private void startAnimator2() {
        ...
        animator2.setInterpolator(EasingFunction.with(new IFunction() {
            @Override
    ...
    private void startAnimator1() {
        ...
        animator1.setEvaluator(EasingFunction.with(new IFunction() {
            @Override
            public float getValue(float input) {
                return input * 2 + 3;
            }
